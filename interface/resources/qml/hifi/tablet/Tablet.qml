...
Item {
    ...
    Rectangle {
        ...
        Component.onCompleted: {
            ...
            var component_a = Qt.createComponent("TabletButton.qml");
            var component_b = Qt.createComponent("TabletButton_LightBlue.qml");
            var component_c = Qt.createComponent("TabletButton_Green.qml");
            component_a.createObject(flowMain);
            component_a.createObject(flowMain);
            component_a.createObject(flowMain);
            component_b.createObject(flowMain);
            component_b.createObject(flowMain);
            component_b.createObject(flowMain);
            component_c.createObject(flowMain);
            component_c.createObject(flowMain);
            component_c.createObject(flowMain);
